...
export default function CreateProductPage() {
  ...
  // Mutations
  const createProduct = api.productManagement.createProduct.useMutation({
    onSuccess: () => {
  ...
  const handleNameEnChange = (value: string) => {
    updateFormData('nameEn', value);
    if (!formData.slug || formData.slug === generateSlug(formData.nameEn)) {
        ...
        <div className="container mx-auto px-4 py-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-gray-600 mt-1">Add a new product to the catalogue</p>
            </div>
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    <p className="text-sm text-gray-600">
                      Specifications can be added after creating the product through the edit form.
                    </p>
                  </div>
                </div>
              )}
