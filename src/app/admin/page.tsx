...
async function getAdminStats() {
  try {
    ...
    // Count inquiries for wholesale accounts (legacy inquiries)
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          ...
          <div className="bg-white p-6 rounded-lg shadow">
            ...
            <p className="text-sm text-gray-600 mt-1">Active wholesale accounts</p>
          </div>
          <div className="bg-white p-6 rounded-lg shadow">
            <h3 className="text-lg font-medium text-gray-900">Account Requests</h3>
            <p className="text-3xl font-bold text-yellow-600 mt-2">{stats.pendingApprovals}</p>
            <p className="text-sm text-gray-600 mt-1">Pending wholesale applications</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          {/* Inquiry Management */}
          <div className="bg-white p-6 rounded-lg shadow">
            <h2 className="text-xl font-semibold text-gray-900 mb-4">Inquiry Management</h2>
            <div className="space-y-4">
              <Link
                href="/admin/inquiries"
                className="block w-full text-left p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors"
              >
                <h3 className="font-medium text-gray-900">Submitted Inquiries</h3>
                <p className="text-sm text-gray-600 mt-1">View and manage all customer inquiry submissions</p>
              </Link>
              <Link
                href="/admin/inquiries?status=pending"
                className="block w-full text-left p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition-colors"
              >
                <h3 className="font-medium text-gray-900">Pending Inquiries</h3>
                <p className="text-sm text-gray-600 mt-1">View inquiries awaiting review and response</p>
              </Link>
            </div>
          </div>
